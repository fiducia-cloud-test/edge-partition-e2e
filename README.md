...
|---|---:|---|
| `fiducia-cloud/fiducia-edge` | `f1449504f67ae8fb642addd667894612068e1014` | `main` |
| `fiducia-cloud/fiducia-node-sidecar.rs` | `b1e54a5ecaa8fb8efdcf81b243e434e4d2b15269` | `main` |
